...
+function($) {
    ...
    Router.prototype.loadPage = function(url) {
        ...
        this.getPage(url, function(page) {
            ...
            if ($("#" + newpageid).length) {
                $("#" + newpageid).replaceWith(page);
            } else {
                page.insertAfter($(".page")[0]);
            }

            if (this.getCurrentPage().attr('pageindex') > page.attr('pageindex')) {
                this.animatePages(this.getCurrentPage(), page, false, 'left');
            }
            else if (this.getCurrentPage().attr('pageindex') == page.attr('pageindex')) {
                this.animatePages(this.getCurrentPage(), page, false, 'stop');
            }
            else {
     ...
     */
    Router.prototype.animatePages = function(leftPage, rightPage, leftToRight, direction) {
